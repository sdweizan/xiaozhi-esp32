...
namespace Lang {
    ...
    namespace Sounds {
        ...
        extern const char ogg_bye_start[] asm("_binary_bye_ogg_start");
        extern const char ogg_bye_end[] asm("_binary_bye_ogg_end");
        static const std::string_view OGG_BYE {
        static_cast<const char*>(ogg_bye_start),
        static_cast<size_t>(ogg_bye_end - ogg_bye_start)
        };

        extern const char ogg_charging_start[] asm("_binary_charging_ogg_start");
        extern const char ogg_charging_end[] asm("_binary_charging_ogg_end");
        static const std::string_view OGG_CHARGING {
        static_cast<const char*>(ogg_charging_start),
        static_cast<size_t>(ogg_charging_end - ogg_charging_start)
        };
        ...
        extern const char ogg_mode_continuous_start[] asm("_binary_mode_continuous_ogg_start");
        extern const char ogg_mode_continuous_end[] asm("_binary_mode_continuous_ogg_end");
        static const std::string_view OGG_MODE_CONTINUOUS {
        static_cast<const char*>(ogg_mode_continuous_start),
        static_cast<size_t>(ogg_mode_continuous_end - ogg_mode_continuous_start)
        };

        extern const char ogg_mode_ptt_btn_sound_start[] asm("_binary_mode_ptt_btn_sound_ogg_start");
        extern const char ogg_mode_ptt_btn_sound_end[] asm("_binary_mode_ptt_btn_sound_ogg_end");
        static const std::string_view OGG_MODE_PTT_BTN_SOUND {
        static_cast<const char*>(ogg_mode_ptt_btn_sound_start),
        static_cast<size_t>(ogg_mode_ptt_btn_sound_end - ogg_mode_ptt_btn_sound_start)
        };

        extern const char ogg_mode_ptt_start[] asm("_binary_mode_ptt_ogg_start");
        extern const char ogg_mode_ptt_end[] asm("_binary_mode_ptt_ogg_end");
        static const std::string_view OGG_MODE_PTT {
        static_cast<const char*>(ogg_mode_ptt_start),
        static_cast<size_t>(ogg_mode_ptt_end - ogg_mode_ptt_start)
        };

        extern const char ogg_net_ok_start[] asm("_binary_net_ok_ogg_start");
        extern const char ogg_net_ok_end[] asm("_binary_net_ok_ogg_end");
        static const std::string_view OGG_NET_OK {
        static_cast<const char*>(ogg_net_ok_start),
        static_cast<size_t>(ogg_net_ok_end - ogg_net_ok_start)
        };
        ...
        extern const char ogg_start_start[] asm("_binary_start_ogg_start");
        extern const char ogg_start_end[] asm("_binary_start_ogg_end");
        static const std::string_view OGG_START {
        static_cast<const char*>(ogg_start_start),
        static_cast<size_t>(ogg_start_end - ogg_start_start)
        };
        ...
        extern const char ogg_wake_start[] asm("_binary_wake_ogg_start");
        extern const char ogg_wake_end[] asm("_binary_wake_ogg_end");
        static const std::string_view OGG_WAKE {
        static_cast<const char*>(ogg_wake_start),
        static_cast<size_t>(ogg_wake_end - ogg_wake_start)
        };
